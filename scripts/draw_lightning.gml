...
argument2=finish x
argument3=finish y
argument4=amount to move towards the finish
argument5=amount to step sideways
argument6=amount to step sideways in the opposite direction
argument7=true or false (whether to renew the direction towards the point)
*/
